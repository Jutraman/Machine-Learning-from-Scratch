function [bestacc,bestc,bestg] = SVMcgForClass(nursery,~,cmin,cmax,gmin,gmax,v,cstep,gstep,accstep)
...
for i = 1:m
    for j = 1:n
        ...
        model = fitcsvm(trainD10(:,1:8), trainD10(:,9),'KernelFunction','Polynomial', 'BoxConstraint',basenum^X(i,j),'PolynomialOrder',basenum^Y(i,j));
